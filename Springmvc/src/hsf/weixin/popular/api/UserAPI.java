...
import hsf.weixin.popular.bean.user.FollowResult;
import hsf.weixin.popular.bean.user.GetblacklistResult;
import hsf.weixin.popular.bean.user.Group;
import hsf.weixin.popular.bean.user.TagsCreatResult;
import hsf.weixin.popular.bean.user.TagsGetResult;
import hsf.weixin.popular.bean.user.TagsGetidlistResult;
import hsf.weixin.popular.bean.user.User;
import hsf.weixin.popular.bean.user.UserInfoList;
import hsf.weixin.popular.bean.user.UserTagGetResult;
import hsf.weixin.popular.client.LocalHttpClient;
import hsf.weixin.popular.util.EmojiUtil;

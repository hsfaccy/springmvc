...
import hsf.weixin.popular.bean.datacube.article.ArticlesummaryResult;
import hsf.weixin.popular.bean.datacube.article.ArticletotalResult;
import hsf.weixin.popular.bean.datacube.article.UserreadResult;
import hsf.weixin.popular.bean.datacube.article.UsershareResult;
import hsf.weixin.popular.bean.datacube.getcardbizuininfo.BizuinInfo;
import hsf.weixin.popular.bean.datacube.getcardbizuininfo.BizuinInfoResult;
import hsf.weixin.popular.bean.datacube.getcardcardinfo.CardInfo;
import hsf.weixin.popular.bean.datacube.getcardcardinfo.CardInfoResult;
import hsf.weixin.popular.bean.datacube.getcardmembercardinfo.MemberCardInfo;
import hsf.weixin.popular.bean.datacube.getcardmembercardinfo.MemberCardInfoResult;
import hsf.weixin.popular.bean.datacube.interfaces.InterfacesummaryResult;
import hsf.weixin.popular.bean.datacube.upstreammsg.UpstreammsgResult;
import hsf.weixin.popular.bean.datacube.user.UsercumulateResult;
import hsf.weixin.popular.bean.datacube.user.UsersummaryResult;
import hsf.weixin.popular.bean.datacube.wxapp.RetaininfoResult;
import hsf.weixin.popular.bean.datacube.wxapp.SummarytrendResult;
import hsf.weixin.popular.bean.datacube.wxapp.VisitdistributionResult;
import hsf.weixin.popular.bean.datacube.wxapp.VisitpageResult;
import hsf.weixin.popular.bean.datacube.wxapp.VisittrendResult;

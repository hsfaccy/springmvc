...
import hsf.weixin.popular.bean.card.CardType;
import hsf.weixin.popular.bean.card.CashCard;
import hsf.weixin.popular.bean.card.DiscountCard;
import hsf.weixin.popular.bean.card.GeneralCouponCard;
import hsf.weixin.popular.bean.card.GiftCard;
import hsf.weixin.popular.bean.card.GrouponCard;
import hsf.weixin.popular.bean.card.batchget.BatchGet;
import hsf.weixin.popular.bean.card.batchget.BatchGetResult;
import hsf.weixin.popular.bean.card.code.checkcode.CodeCheckCode;
import hsf.weixin.popular.bean.card.code.checkcode.CodeCheckCodeResult;
import hsf.weixin.popular.bean.card.code.consume.CodeConsume;
import hsf.weixin.popular.bean.card.code.consume.CodeConsumeResult;
import hsf.weixin.popular.bean.card.code.decrypt.CodeDecrypt;
import hsf.weixin.popular.bean.card.code.decrypt.CodeDecryptResult;
import hsf.weixin.popular.bean.card.code.deposit.CodeDeposit;
import hsf.weixin.popular.bean.card.code.deposit.CodeDepositResult;
import hsf.weixin.popular.bean.card.code.get.CodeGet;
import hsf.weixin.popular.bean.card.code.get.CodeGetResult;
import hsf.weixin.popular.bean.card.code.getdepositcount.CodeGetDepositCount;
import hsf.weixin.popular.bean.card.code.getdepositcount.CodeGetDepositCountResult;
import hsf.weixin.popular.bean.card.code.unavailable.CodeUnavailable;
import hsf.weixin.popular.bean.card.code.update.CodeUpdate;
import hsf.weixin.popular.bean.card.create.Create;
import hsf.weixin.popular.bean.card.create.CreateResult;
import hsf.weixin.popular.bean.card.get.AbstractResult;
import hsf.weixin.popular.bean.card.get.GetCashResult;
import hsf.weixin.popular.bean.card.get.GetDiscountResult;
import hsf.weixin.popular.bean.card.get.GetGeneralCouponResult;
import hsf.weixin.popular.bean.card.get.GetGrouponResult;
import hsf.weixin.popular.bean.card.get.GetResult;
import hsf.weixin.popular.bean.card.landingpage.create.LandingPageCreate;
import hsf.weixin.popular.bean.card.landingpage.create.LandingPageCreateResult;
import hsf.weixin.popular.bean.card.modifystock.ModifyStock;
import hsf.weixin.popular.bean.card.mpnews.gethtml.MpNewsGetHtml;
import hsf.weixin.popular.bean.card.mpnews.gethtml.MpNewsGetHtmlResult;
import hsf.weixin.popular.bean.card.paycell.set.PaySellSet;
import hsf.weixin.popular.bean.card.qrcode.create.QrCodeCreate;
import hsf.weixin.popular.bean.card.qrcode.create.QrCodeCreateMultiple;
import hsf.weixin.popular.bean.card.qrcode.create.QrCodeCreateResult;
import hsf.weixin.popular.bean.card.testwhitelist.set.TestWhiteListSet;
import hsf.weixin.popular.bean.card.update.UpdateCash;
import hsf.weixin.popular.bean.card.update.UpdateDiscount;
import hsf.weixin.popular.bean.card.update.UpdateGeneralCoupon;
import hsf.weixin.popular.bean.card.update.UpdateGift;
import hsf.weixin.popular.bean.card.update.UpdateGroupon;
import hsf.weixin.popular.bean.card.update.UpdateResult;
import hsf.weixin.popular.bean.card.user.getcardlist.UserGetCardList;
import hsf.weixin.popular.bean.card.user.getcardlist.UserGetCardListResult;
